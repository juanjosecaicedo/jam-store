        ...
        <div class="p-6">
            @if ($step == $currentStep)
                <div class="grid grid-cols-6 gap-4">
                    ...
                    <x-input.group
                        class="col-span-3 focus:outline-none"
                        label="Last name"
                    ...
                    >
                        <select
                            class="w-full p-3 border border-gray-100 sm:text-sm focus:outline-none focus:border-gray-300"
            ...
            @if ($step == $currentStep)
                <div class="mt-6 text-right">
                    <button
                        class="px-5 py-3 text-sm font-medium text-white bg-black hover:opacity-90"
                        type="submit"
                        wire:key="submit_btn"
