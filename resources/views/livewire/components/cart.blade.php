...
>
    <button
        class="inline-grid grid-cols-2 items-center w-16 h-16 transition border-l border-gray-100 lg:border-l-transparent hover:opacity-75"
    ...
    >
        ...
        <span class="place-self-center">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24"
             ...
             @if ($this->cart)
                <span
                    class="absolute flex justify-center items-center left-5 top-3 h-5 w-5 rounded-full bg-black text-white">
    ...
    >
                                    ...
                                    >
                                        ...
                                        <div class="flex-1 ml-4">
                                            ...
                                            <div class="flex items-center mt-2">
                                                <input
                                                    class="w-16 p-2 text-xs transition-colors border border-gray-100 hover:border-gray-300 focus:outline-none"
                                                    type="number"
        ...
        @if ($this->cart)
            <div class="mt-4 space-y-4 text-center">
                <button
                    class="block w-full p-3 text-sm font-medium text-black border border-black hover:ring-1 hover:ring-gray-900"
                    type="button"
                ...
                <a
                    class="block w-full p-4 text-sm font-medium text-center text-white bg-black hover:opacity-95"
