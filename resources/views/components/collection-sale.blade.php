<section>
    <div class="p-8 overflow-hidden bg-gray-100 border-gray-900">
        <div class="sm:py-32 sm:relative">
            <div>
                ...
                <a
                    ...
                    class="inline-block px-5 py-3 mt-6 text-sm font-medium text-white bg-black hover:ring-1 hover:ring-black"
                >
                    Shop the Sale
                </a>
            </div>
